					...
					@foreach ($sliders as $slide)
	       				<div class="item-slide">
						    ...
						    <div class="slide-info slide-1">
						        ...
						        <p class="sale-info">Only from: <span class="price">RM {{$slide->price}}</span></p>
						...
						@foreach ($sproducts as $sproduct)
							<div class="product product-style-2 equal-elem ">
								...
								<div class="product-info">
									...
									<div class="wrap-price"><ins><p class="product-price">RM{{$sproduct->sale_price}}</p></ins> <del><p class="product-price">RM{{$sproduct->regular_price}}</p></del></div>
								</div>
							</div>
						@endforeach
					</div>
